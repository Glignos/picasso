...
RECORDS_REST_ENDPOINTS = {
    'recid': dict(
        ...
        search_type=None,
        record_serializers={
            'application/json': ('picasso.records.serializers'
                                 ':json_v1_response'),
        },
        search_serializers={
            'application/json': ('picasso.records.serializers'
        ...
        record_loaders={
            'application/json': ('picasso.records.loaders'
                                 ':json_v1'),
        },
        list_route='/records/',
...
PICASSO_ENDPOINTS_ENABLED = True
